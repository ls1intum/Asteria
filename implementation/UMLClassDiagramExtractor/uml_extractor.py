...
class UML_extractor:
    ...
    def map_relations_to_graph(self, relations):
        ...
        print(f"type = {type(relations_dicts)}")
        print(f"relations_dicts = {relations_dicts}")
        resulting_entity_pairs = []
        resulting_relations = []
        for relation_dict in relations_dicts:
            print(f"type_relation_dict = {type(relation_dict)}")
...
uml_solution_path = "/home/maisa/Desktop/athene_knowledge_graphs/implementation/UMLClassDiagramExtractor/UMLClassDiagram.json"
