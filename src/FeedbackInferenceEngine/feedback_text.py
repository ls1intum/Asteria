class FeedbackText:
    ...
    def get_missing_associations_feedback(element_name: str, missing_associations: [str]) -> str:
        ...
        return f"You forgot to mention the association {associations_str} that starts from {element_name}!"
    ...
    def get_superfluous_associations_feedback(element_name: str, superfluous_associations: [str]) -> str:
        ...
        return f"You have superfluous association {associations_str} that starts from {element_name}!"
