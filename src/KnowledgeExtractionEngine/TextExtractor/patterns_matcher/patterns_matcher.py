...
from KnowledgeExtractionEngine.TextExtractor.patterns_matcher.entity_pattern_builder import EntityPatternsBuilder
from KnowledgeExtractionEngine.TextExtractor.patterns_matcher.relation_pattern_builder import RelationPatternBuilder
